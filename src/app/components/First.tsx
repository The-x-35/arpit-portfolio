  ...
  return (
     <section className={`w-full h-screen mx-auto`}>
        <div className='flex flex-col justify-center items-center'>
          <div
            className={"absolute inset-0 top-[120px] left-10 max-w-7xl mx-auto px-6 flex flex-row items-start gap-5"}
          >
            ...
            <div>
              ...
              <p className={"text-[#dfd9ff] font-medium lg:text-[21px] sm:text-[26px] xs:text-[20px] text-[16px] lg:leading-[40px] mt-2 text-white-100"}>
                I am a Cyber Security Enthusiast, <br className='sm:block hidden' />
                Web and Software Developer.
              </p>
            
            </div>
              <div className='flex flex-col justify-center items-center -mt-48 mx-auto -mr-10 h-full w-full -mb-96 -bottom-96'>
              <ComputersCanvas />
              </div>
        </div>
